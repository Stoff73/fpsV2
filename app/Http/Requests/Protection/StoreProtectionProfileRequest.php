...
class StoreProtectionProfileRequest extends FormRequest
{
    ...
    {
        return [
            'annual_income' => ['required', 'numeric', 'min:0', 'max:9999999999999.99'],
            'monthly_expenditure' => ['required', 'numeric', 'min:0', 'max:9999999.99'],
            ...
            'retirement_age' => ['required', 'integer', 'min:50', 'max:85'],
