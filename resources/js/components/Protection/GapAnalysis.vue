    ...
    <div v-if="hasNoPolicies" class="mb-6 bg-amber-50 border-l-4 border-amber-400 p-4">
      <div class="flex items-start">
        <div class="flex-shrink-0">
          <svg class="h-5 w-5 text-amber-400" fill="currentColour" viewBox="0 0 20 20">
        ...
        <div class="ml-3 flex-1">
          ...
          <div class="mt-2 text-sm text-amber-700">
            ...
            <button
              ...
              class="inline-flex items-centre px-4 py-2 bg-amber-600 text-white text-sm font-medium rounded-md hover:bg-amber-700 transition-colours"
            >
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div class="space-y-2 text-sm">
              ...
              <div class="flex justify-between items-centre text-xs pl-4">
              ...
              <div class="flex justify-between items-centre pt-1 border-t border-blue-200">
              ...
              <div v-if="continuingIncome > 0" class="flex justify-between items-centre pt-1 text-green-700">
                <div class="flex items-centre">
                  <span class="font-medium">Add: Your Rental/Dividend Income</span>
                  <div class="ml-2 group relative">
                    <svg class="w-4 h-4 text-green-400 cursor-help" fill="currentColour" viewBox="0 0 20 20">
              ...
              <div v-if="spouseIncluded && spouseNetIncome > 0" class="flex justify-between items-centre pt-1 text-green-700">
              ...
              <div v-if="spouseIncluded && spouseContinuingIncome > 0" class="flex justify-between items-centre text-green-700">
              ...
              <!-- Income Difference -->
              <div class="flex justify-between items-centre pt-2 border-t border-blue-300 bg-blue-100 -mx-2 px-2 py-1 rounded">
                <div class="flex items-centre">
                  <span class="font-semibold text-gray-900">Net Income Replacement Need</span>
                  <div class="ml-2 group relative">
                    <svg class="w-4 h-4 text-gray-400 cursor-help" fill="currentColour" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd" />
                    </svg>
                    <div class="hidden group-hover:block absolute z-10 w-64 p-2 mt-2 text-xs text-white bg-gray-900 rounded-lg shadow-lg -left-32">
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div class="space-y-4">
            ...
            <div class="pl-4 space-y-3">
              ...
              <div v-if="excessUnused > 0" class="flex justify-between items-centre text-amber-700">
