      ...
      <div class="flex items-centre justify-between">
        ...
        <div class="flex items-centre space-x-2">
          <button
            ...
            class="p-2 text-gray-400 hover:text-indigo-600 transition-colours duration-200"
            title="Edit"
          >
          ...
          <button
            ...
            class="p-2 text-gray-400 hover:text-red-600 transition-colours duration-200"
            title="Delete"
          >
            <svg class="w-5 h-5" fill="none" stroke="currentColour" viewBox="0 0 24 24">
          ...
          <button
            ...
            class="p-2 text-gray-400 hover:text-gray-600 transition-colours duration-200"
            :title="expanded ? 'Collapse' : 'Expand'"
          >
            <svg class="w-5 h-5 transform transition-transform duration-200" :class="{ 'rotate-180': expanded }" fill="none" stroke="currentColour" viewBox="0 0 24 24">
