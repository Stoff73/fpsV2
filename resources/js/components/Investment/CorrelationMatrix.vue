    ...
    <div v-else class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4">
          ...
          <p class="text-2xl font-bold" :class="getCorrelationColor(correlationData.statistics?.max_correlation)">
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4">
          ...
          <p class="text-2xl font-bold" :class="getCorrelationColor(correlationData.statistics?.min_correlation)">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="(row, rowIndex) in correlationData.matrix" :key="rowIndex">
                ...
                <td
                  ...
                  :class="getCellColorClass(value, rowIndex, colIndex)"
...
export default {
  ...
  methods: {
    ...
    getCellColorClass(value, rowIndex, colIndex) {
