<template>
  <div class="tax-optimization-recommendations">
    <h3 class="text-lg font-semibold text-gray-800 mb-4">Tax Optimization Recommendations</h3>
    ...
    <!-- No Data State -->
    <div v-if="!recommendations || recommendations.recommendations.length === 0" class="text-centre py-12 text-gray-500">
      ...
      <div v-if="highPriorityRecs.length > 0" class="mb-6">
        ...
        <div class="space-y-3">
          ...
          >
            ...
            <div v-if="rec.potential_saving || rec.tax_saving" class="mt-3 flex items-centre">
            ...
            <div v-if="rec.notes && rec.notes.length > 0" class="mt-3 space-y-1">
              <p class="text-xs text-gray-600" v-for="(note, i) in rec.notes" :key="i">💡 {{ note }}</p>
            </div>
          </div>
        </div>
      </div>
