      ...
      <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button
            ...
            class="text-left p-4 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-colours"
          >
      ...
      <div class="bg-gradient-to-br from-yellow-50 to-orange-50 border border-yellow-200 rounded-lg shadow-md p-6">
        ...
        <div class="space-y-3">
          <div class="flex items-start">
            <svg class="h-5 w-5 text-yellow-600 mr-3 mt-0.5 flex-shrink-0" fill="currentColour" viewBox="0 0 20 20">
