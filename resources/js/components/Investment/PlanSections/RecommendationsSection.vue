<template>
  <div class="recommendations-section">
    ...
    <div v-if="!data || !data.all_recommendations || data.all_recommendations.length === 0" class="text-centre py-8 text-gray-500">
    ...
    <div v-else class="space-y-6">
      ...
      <div class="flex flex-wrap gap-3">
        ...
        <button
          @click="resetFilters"
          class="px-3 py-2 text-sm text-gray-600 hover:text-gray-800 transition-colours duration-200"
        >
          Reset Filters
        </button>
      </div>
      ...
      <div v-if="filteredHighPriorityRecs.length > 0" class="mb-6">
        <h5 class="text-md font-semibold text-red-800 mb-3 flex items-centre">
        ...
        <div class="space-y-3">
          ...
          >
            ...
            <div v-if="rec.potential_saving" class="mt-3 flex items-centre">
              <svg class="w-4 h-4 text-green-600 mr-1" fill="currentColour" viewBox="0 0 20 20">
      ...
      <div v-if="filteredMediumPriorityRecs.length > 0" class="mb-6">
        <h5 class="text-md font-semibold text-amber-800 mb-3 flex items-centre">
          <svg class="w-5 h-5 mr-2" fill="currentColour" viewBox="0 0 20 20">
      ...
      <div v-if="filteredLowPriorityRecs.length > 0">
        <h5 class="text-md font-semibold text-blue-800 mb-3 flex items-centre">
          <svg class="w-5 h-5 mr-2" fill="currentColour" viewBox="0 0 20 20">
