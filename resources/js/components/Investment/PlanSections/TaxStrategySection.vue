  ...
  <div class="tax-strategy-section">
    ...
    <div v-else class="space-y-6">
      ...
      <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-6 border border-green-200">
        <div class="flex justify-between items-center">
          <div>
            ...
            <p class="text-4xl font-bold" :class="getEfficiencyColor(data.efficiency_score)">
          ...
          <div class="text-right">
            <p class="text-sm text-gray-600 mb-1">Potential Annual Tax Savings</p>
            <p class="text-2xl font-bold text-green-600">£{{ formatNumber(data.potential_annual_saving || 0) }}</p>
            <p class="text-xs text-gray-500 mt-1">Through optimization</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white border border-gray-200 rounded-lg p-5">
        <h5 class="text-sm font-semibold text-gray-700 mb-4">ISA Allowance (2025/26)</h5>
        <div class="mb-4">
          <div class="flex justify-between text-sm mb-2">
            <span class="text-gray-600">Allowance Usage</span>
          ...
          <div class="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
            <div
              ...
              :class="getIsaBarColor(data.isa_utilization)"
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <p class="text-2xl font-bold text-gray-800">£{{ formatNumber(data.harvestable_losses || 0) }}</p>
          <p class="text-xs text-gray-600 mt-1">Available losses</p>
        </div>
        ...
        <div class="bg-amber-50 border border-amber-200 rounded-lg p-4">
          ...
          <p class="text-2xl font-bold text-gray-800">{{ data.bed_and_isa_opportunities || 0 }}</p>
          <p class="text-xs text-gray-600 mt-1">Transfer opportunities</p>
        </div>
        ...
        <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
          ...
          <p class="text-2xl font-bold text-gray-800">{{ formatPercentage(data.location_efficiency || 0) }}%</p>
          <p class="text-xs text-gray-600 mt-1">Optimization score</p>
        </div>
      </div>

      <!-- Key Recommendations -->
      <div v-if="data.recommendations && data.recommendations.length > 0" class="bg-white border border-gray-200 rounded-lg p-5">
        <h5 class="text-sm font-semibold text-gray-700 mb-4">Tax Optimization Actions</h5>
        <div class="space-y-3">
          <div
