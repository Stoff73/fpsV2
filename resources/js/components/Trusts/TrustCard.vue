<template>
  <div class="card hover:shadow-lg transition-shadow">
    ...
    <div v-if="trust.is_relevant_property_trust" class="mb-4">
      <span class="inline-flex items-centre px-2 py-1 text-xs font-medium text-amber-800 bg-amber-100 rounded-full">
    ...
    <!-- Actions -->
    <div class="flex items-centre justify-between pt-4 border-t border-gray-200">
      <button
      ...
      <div class="flex items-centre space-x-2">
        <button
          ...
          class="p-2 text-gray-600 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-colours"
