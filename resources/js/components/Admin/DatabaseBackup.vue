  ...
  <div class="space-y-6">
    ...
    <div class="flex items-centre justify-between">
      ...
      >
        ...
        <svg v-else class="w-5 h-5 mr-2" fill="none" stroke="currentColour" viewBox="0 0 24 24">
    ...
    <div v-else class="card">
      <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex items-centre justify-between">
          ...
          <button
            class="text-sm text-primary-600 hover:text-primary-700 inline-flex items-centre"
            @click="loadBackups"
          >
      ...
      <!-- Empty State -->
      <div v-if="!backups || backups.length === 0" class="px-6 py-12 text-centre">
        <svg
            ...
            <tr v-for="backup in backups" :key="backup.filename">
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-centre">
                  <svg class="w-5 h-5 text-gray-400 mr-2" fill="none" stroke="currentColour" viewBox="0 0 24 24">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                <button
                  class="text-primary-600 hover:text-primary-900 inline-flex items-centre"
                ...
                <button
                  class="text-red-600 hover:text-red-900 inline-flex items-centre"
    ...
    <div class="card bg-yellow-50 border-yellow-200">
      <div class="flex items-start">
        <div class="flex-shrink-0">
          <svg class="h-6 w-6 text-yellow-600" fill="none" stroke="currentColour" viewBox="0 0 24 24">
