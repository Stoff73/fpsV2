      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div class="bg-white rounded-lg shadow-md p-6 opacity-60">
            ...
            <p class="text-gray-600 mb-4">
              Comprehensive retirement readiness analysis, pension optimization, and income projection planning
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-md p-6 opacity-60">
            ...
            <p class="text-gray-600 mb-4">
              IHT planning, gifting strategies, life policy optimization, and asset protection for your estate
            </p>
          </div>
        </div>
