<template>
  <div class="recommendations">
      ...
      <div class="flex items-centre justify-between">
        ...
        <div class="flex items-centre space-x-2">
          <button
            ...
            :class="[
              'px-4 py-2 rounded-lg text-sm font-medium transition-colours duration-200',
        ...
        <div class="p-6">
          <div class="flex items-start justify-between mb-4">
            <div class="flex items-start flex-1">
              <div
                :class="[
                  'flex-shrink-0 w-10 h-10 rounded-full flex items-centre justify-centre mr-4',
                  getPriorityBgClass(recommendation.priority)
                ]"
              >
                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColour" viewBox="0 0 24 24">
    ...
    <div v-else class="bg-white rounded-lg shadow p-12 text-centre">
      <svg class="w-16 h-16 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColour" viewBox="0 0 24 24">
  ...
  data() {
    return {
      ...
      priorities: [
        ...
        { value: 'Medium', label: 'Medium', activeClass: 'bg-amber-600 text-white' },
